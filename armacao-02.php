...
<head>
    ...
    <title>Planta de amarracao 3D</title>
    <link rel="stylesheet" href="assets/styles.css?v=<?php echo urlencode((string) @filemtime(__DIR__ . '/assets/styles.css')); ?>">
</head>
<body data-page="armacao-02" class="rigging-layout rigging-layout--unified">
                ...
                <section class="panel">
                    <div class="panel-heading">
                        <div>
                            ...
                            <h2>Componentes de amarracao 3D</h2>
                        </div>
            ...
            <main class="main-column rigging-main-column">
                ...
                <section class="panel workspace-panel">
                    <div class="workspace-head">
                        <div>
                            <p class="eyebrow">Amarracao 3D</p>
                            <h2>Palco unico 3D</h2>
                        </div>
                        <div class="workspace-head__controls">
                            <p class="panel-help">Clique na area</p>
                        ...
                        <div id="rigging2PreviewWrap" class="rigging-preview-wrap rigging-preview-wrap--unified">
                            <div class="rigging2-workspace-hidden" aria-hidden="true">
                                <div id="rigging2Workspace" class="workspace rigging-workspace"></div>
                            </div>
                            <canvas id="rigging2Preview" class="rigging-preview rigging-preview--unified" width="1280" height="720"></canvas>
            ...
            <aside id="rigging2EditSidebar" class="sidebar sidebar--right rigging-sidebar rigging-sidebar--edit">
                ...
                <section class="panel">
                    ...
                    <form id="rigging2SelectionForm" class="selection-form" hidden>
                        ...
                        <div class="field-row">
                            <label class="field field--small">
                                <span id="rigging2WidthLabel">Largura X (m)</span>
                                <input id="rigging2SelectedWidth" type="number" min="0.05" step="0.05">
                            </label>
                            <label class="field field--small">
                                <span id="rigging2HeightLabel">Altura Y (m)</span>
                                <input id="rigging2SelectedHeight" type="number" min="0.05" step="0.05">
                            </label>
                        </div>
                        <label class="field">
                            <span id="rigging2DepthLabel">Profundidade Z (m)</span>
                            <input id="rigging2SelectedDepth" type="number" min="0.02" step="0.01">
                        </label>
                        <p id="rigging2DimensionHint" class="panel-help">No palco unico a base e o volume aparecem juntos. Use o painel quando quiser editar valores exatos.</p>
                        <label class="field rigging2-hidden-field">
                            <span>Plano 3D da peca</span>
                            <select id="rigging2SelectedMountMode">
                        ...
                        <div class="action-row action-row--compact rigging2-hidden-field">
                            <button id="rigging2ZUp50" type="button" class="secondary-btn">+0.50m</button>
                            <button id="rigging2ZDown50" type="button" class="secondary-btn">-0.50m</button>
                        </div>
                ...
                <section class="panel">
                    <div class="panel-heading">
                        <div>
                            ...
                            <h2>Projetos de amarracao 3D</h2>
                        </div>
                ...
                <section class="panel">
                    ...
                    <div id="rigging2Status" class="status-box status-box--info">Carregando editor de amarracao 3D...</div>
                </section>
            </aside>
        </div>
    </div>
    ...
    <script src="assets/nav.js?v=<?php echo urlencode((string) @filemtime(__DIR__ . '/assets/nav.js')); ?>" defer></script>
    <script src="assets/armacao-02.js?v=<?php echo urlencode((string) @filemtime(__DIR__ . '/assets/armacao-02.js')); ?>" defer></script>
</body>
</html>
